...
const Footer = () => {
  ...
  return (
    <footer className="bg-[hsl(var(--header-bg))] text-white">
      <div className="container mx-auto max-w-7xl px-4 lg:px-10 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-white/70">
              Cuidado e carinho na melhor fase da vida.
            </p>
          </div>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/50 text-sm">
          <p>© 2024 Casa de Repouso Aconchego. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
